...
//force RegExp to have a toJson function to allow cache key generation with regexes
...
module.exports = class Collection {
  ...
  constructor(dbInstance, collectionName, cacheClient) {
    ...
    if (cacheClient) {
      this.emptyDocument = {"_inCache": true};
  ...
  async storeInCache(query, options, value) {
    ...
    if (Array.isArray(value)) {
      ...
      valueToStore = Object.assign(this.emptyDocument, value);
    }
